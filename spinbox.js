    ...
    return this.each(function(){
        ...
        if( options.mousewheel ){
            $(this).bind("mousewheel.spinbox DOMMouseScroll.spinbox", function(e){
                ...
                if ( e.originalEvent.detail < 0 || e.originalEvent.wheelDelta >= 120 ) {
                    adjustValue.apply( this, [e, step, 1] );//console.log('ok');
                }
                else if ( e.originalEvent.detail > 0 || e.originalEvent.wheelDelta <= -120 ) {
                    adjustValue.apply( this, [e, step, -1] );//console.log('ok');
                }
